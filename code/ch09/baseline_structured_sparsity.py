"""Baseline dense GEMM using a 2:4-pruned weight matrix."""
...
class BaselineStructuredSparsityBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Dense GEMM baseline using a 2:4-pruned weight matrix."""
    ...
    def benchmark_fn(self) -> None:
        ...
        with self._nvtx_range("baseline_structured_sparsity"):
...
def get_benchmark() -> BaseBenchmark:
    return BaselineStructuredSparsityBenchmark()
