"""Baseline dense GEMM for a batch-heavy 2:4-pruned weight matrix."""
...
class BaselineStructuredSparsityBatchBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Dense GEMM baseline for a batch-heavy 2:4-pruned weight matrix."""
    ...
    def benchmark_fn(self) -> None:
        ...
        with self._nvtx_range("baseline_structured_sparsity_batch"):
...
def get_benchmark() -> BaseBenchmark:
    return BaselineStructuredSparsityBatchBenchmark()
