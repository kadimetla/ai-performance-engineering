...
class BaselineEvalStackBenchmark(VerificationPayloadMixin, BaseBenchmark):
    ...
    def benchmark_fn(self) -> None:
        ...
        if captured:
            try:
                ...
                print(json.dumps({"event": "eval_stack_stdout", "variant": "baseline", "lines": lines}), file=sys.stderr)
            except Exception:
