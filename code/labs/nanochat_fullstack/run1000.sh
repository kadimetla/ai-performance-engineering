...
python -m labs.nanochat_fullstack.scripts.tok_train --max_chars=4000000000
...
torchrun --standalone --nproc_per_node=$NPROC_PER_NODE -m labs.nanochat_fullstack.scripts.mid_train -- --device_batch_size=8 --run=$WANDB_RUN
